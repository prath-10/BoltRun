...
from BoltRun.definitions import ABORTED_TASK, SUCCESS_TASK
from BoltRun.tasks import create_scan_activity, initiate_scan, run_command
    ...
    if request.method == "POST":
        ...
        if scheduled_mode == 'periodic':
            ...
            PeriodicTask.objects.create(interval=schedule,
                                        name=task_name,
                                        task='BoltRun.tasks.initiate_scan',
...
def create_report(request, id):
    ...
    if vuln_report_query.exists():
        ...
        data['show_boltrun_banner'] = report.show_boltrun_banner
