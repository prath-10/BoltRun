...
from BoltRun.common_serializers import *
...
def get_http_urls(
	...
	if ignore_files: # ignore all files
		extensions_path = f'{BOLTRUN_HOME}/fixtures/extensions.txt'
...
def get_task_cache_key(func_name, *args, **kwargs):
	...
	kwargs_str = '_'.join([f'{k}={v}' for k, v in kwargs.items() if k not in BOLTRUN_TASK_IGNORE_CACHE_KWARGS])
