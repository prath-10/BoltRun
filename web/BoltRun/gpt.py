import openai
import re
from BoltRun.common_func import get_open_ai_key, extract_between
from BoltRun.definitions import VULNERABILITY_DESCRIPTION_SYSTEM_MESSAGE, ATTACK_SUGGESTION_GPT_SYSTEM_PROMPT
