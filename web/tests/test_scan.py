...
os.environ['BOLTRUN_SECRET_KEY'] = 'secret'
os.environ['CELERY_ALWAYS_EAGER'] = 'True'

import yaml
from celery.utils.log import get_task_logger
from BoltRun.settings import DEBUG
from BoltRun.tasks import (dir_file_fuzz, fetch_url, http_crawl, initiate_scan,
...
class TestOnlineScan(unittest.TestCase):
    ...
    def test_subdomain_discovery(self):
        domain = DOMAIN_NAME.lstrip('boltrun.')
