...
from BoltRun.validators import validate_short_name
...
class ReportForm(forms.ModelForm):
    ...
    show_boltrun_banner = forms.BooleanField(
        required=False,
        widget=forms.CheckboxInput(
            attrs={
                "class": "form-check-input",
                "id": "show_boltrun_banner",
            }))
    ...
    def set_value(self, key):
        ...
        self.initial['show_boltrun_banner'] = key.show_boltrun_banner
    ...
    def set_initial(self):
        self.initial['show_boltrun_banner'] = True
...
**{company_name}** performed both Security Audit and Reconnaissance using automated tool BoltRun. https://github.com/yogeshojha/boltrun .
